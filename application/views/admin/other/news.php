		...
		<div class="block-header">
			<div class="row">
				<div class="col-lg-7 col-md-6 col-sm-12">
					<h2><?=isset($details)?'Edit':'Add'?> NRC News </h2>
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="<?=base_url('admin')?>"><i class="zmdi zmdi-home"></i> Genocide </a>
						</li>
						<li class="breadcrumb-item"><a href="javascript:void(0);">OTHER News </a></li>
						<li class="breadcrumb-item active"> <?=isset($details)?'Edit':'Add'?> OTHER News</li>
					</ul>
		...
		<div class="container-fluid">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<div class="card">
						<div class="header">
							<h2><strong><?=isset($details)?'Edit':'Add'?> OTHER News </strong> </h2>
						</div>
						<div class="body">
							<form id="frmOtherNews" method="" action="" enctype="multipart/form-data">
								...
								<a href="<?= base_url('admin/nrc/news-list') ?>" class="btn btn-raised btn-info btn-round waves-effect">Back</a>
...
<script>
   $(document).ready(function () {
    ...
    $('#frmOtherNews').submit(function(e){
        e.preventDefault();
        if($('#nrc_categorie_id').val() == ""){
        ...
        $.ajax({
            type: "POST",
            url: base_url + "other/News/otherSave",
            data: fd,
            processData: false,
            contentType: false,
            beforeSend: function() {
            ...
            success: function(response) {
              console.log(response);           
                if(response.status.error_code == 0){
                    swalAlertThenRedirect(response.status.message, 'success', base_url+"other/news-list");
                }else{
