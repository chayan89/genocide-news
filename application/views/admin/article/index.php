		...
		<div class="container-fluid">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<div class="card">
						<div class="header">
							<h2><strong>Add Article </strong> </h2>
						</div>
						<div class="body">
							<form id="frmArticle" method="" action="" enctype="multipart/form-data">
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#frmArticle').submit(function(e){
        ...
        $.ajax({
            type: "POST",
            url: base_url + "article/index/articleSave",
            data: fd,
            processData: false,
            contentType: false,
            beforeSend: function() {
            ...
            success: function(response) {  
                if(response.status.error_code == 0){
                  ...
                  swalAlertThenRedirect(response.status.message, 'success', base_url+"article");
                }else{
  ...
  function drawTable(){
    ...
    $.ajax({
          type: "POST",
          url: base_url + "article/index/get",
