    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Add Gallery Category </strong> </h2>
                    </div>
                    <div class="body">
                        <form id="frmGalleryCategory" method="" action="">
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#frmGalleryCategory').submit(function(e){
        e.preventDefault();
        ...
        $.ajax({
            type: "POST",
            url: base_url + "gallery/category/categorySave",
  ...
  function drawTable(){
    ...
    $.ajax({
          type: "POST",
          url: base_url + "gallery/category/get",
