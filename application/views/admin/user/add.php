...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="neworder_l_inner">
          <h3>Admin Profile<? //=isset($details)?'Edit':'Add'?></h3>
        </div>
      </div>
      <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="neworder_r">
          <ul>
            <!-- <li><a href="<?=base_url('admin/vendor')?>">User List</a></li> -->
          </ul>
        </div>
      </div>
    </div>
  ...
  <form id="frm-vendor" action="<?=base_url('admin/user/usersave')?>" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-12 col-xs-12">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" id="first_name" name="first_name" placeholder="Enter First Name" value="<?=$details['fname'];?>"/>  
            <p id="first_check"></p>
            </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12">
          <div class="form-group">
            ...
            <input class="form-control" type="text" id="last_name" name="last_name" placeholder="Enter Last Name" value="<?=$details['lname'];?>"/>
            <p id="last_check"></p>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12">
          <div class="form-group">
            ...
            <input class="form-control" type="email" id="email" name="email" placeholder="abcd@mail.com" value="<?=$details['email'];?>"/>
            <p id="email_check"></p>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12">
          <div class="form-group">
            ...
            <input class="form-control" type="tel" minlength="10" maxlength="15" id="mobile" name="mobile" placeholder="98786543987" value="<?=$details['mobile'];?>" oninput="this.value = this.value.replace(/[^0-9]/g, '')"/>
            <p id="mobile_check"></p>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12">
          <div class="form-group">
            ...
            <input class="form-control" type="text" id="address" name="address" placeholder="Address" value="<?=$details['address'];?>"/>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12 image-section" style="display:<?=isset($details)?'':'none'?>">
          <div class="form-group">
            <img src="<?=base_url('/public/admin/img/')?><?=isset($details)?$details['profile_image']:base_url('uploads/vendor/').'no_image.png'?>" alt="preview" id="preview-image" style="width: 100px; display: <?=isset($details)?'':'none'?>">
          </div>
        </div>
