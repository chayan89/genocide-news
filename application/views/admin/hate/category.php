    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Add Hate Category </h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> Genocide </a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0);"> hate </a></li>
                    <li class="breadcrumb-item active">  Add Hate Category</li>
                </ul>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Add Hate Category </strong> </h2>
                    </div>
                    <div class="body">
                        <form id="frmHateCategory" method="" action="">
...
<script>
  adminPage = "hateCategory";
  var id = '';
  $(document).ready(function(){
    drawTable();

    $('#frmHateCategory').submit(function(e){
        e.preventDefault();
        ...
        $.ajax({
            type: "POST",
            url: base_url + "hate/category/categorySave",
  ...
  function drawTable(){
    ...
    $.ajax({
          type: "POST",
          url: base_url + "hate/category/get",
