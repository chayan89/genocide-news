    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Add genocide Category </h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> Genocide </a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0);"> genocide </a></li>
                    <li class="breadcrumb-item active">  Add genocide Category</li>
                </ul>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Add genocide Category </strong> </h2>
                    </div>
                    <div class="body">
...
<script>
  adminPage = "genocideCategory";
  var id = '';
  $(document).ready(function(){
    drawTable();

    $('#frmgenocideCategory').submit(function(e){
        e.preventDefault();
        ...
        $.ajax({
            type: "POST",
            url: base_url + "genocide/category/categorySave",
  ...
  function drawTable(){
    ...
    $.ajax({
          type: "POST",
          url: base_url + "genocide/category/get",
