        ...
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">  Add Legal Category</li>
                </ul>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Add Legal Category </strong> </h2>
                    </div>
                    <div class="body">
                        <form id="frmLegalCategory" method="" action="">
...
<script>
  adminPage = "legalCategory";
  var id = '';
  $(document).ready(function(){
    drawTable();

    $('#frmLegalCategory').submit(function(e){
        e.preventDefault();
        ...
        $.ajax({
            type: "POST",
            url: base_url + "legal/category/categorySave",
  ...
  function drawTable(){
    ...
    $.ajax({
          type: "POST",
          url: base_url + "legal/category/get",
