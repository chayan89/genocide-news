			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<div class="card">
						...
						<div class="body">
							<form id="frmNews" method="" action="" enctype="multipart/form-data">
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#frmNews').submit(function(e){
        ...
        $.ajax({
            type: "POST",
            url: base_url + "news/index/newsSave",
            data: fd,
            processData: false,
            contentType: false,
            beforeSend: function() {
            ...
            success: function(response) {  
                if(response.status.error_code == 0){
                  ...
                  swalAlertThenRedirect(response.status.message, 'success', base_url+"news");
                }else{
