<section class="sec-padding section-light sec-m-margin-1 cms-page-head">
	<div class="container">
...
<!-- end section -->
<section class="section-light cms-page">
    <div class="container">
    <h4 style="color: #fff;"><?= $details->title?></h4>
        <div class="row">
            <div class="col-md-12">
                <img src="<?= base_url('uploads/thumbnail/'.$details->image) ?>" style="margin-bottom: 2em; width: 800px">
            </div>
